...
int main (int argc, char **argv)
{
   ...
   joint_recorder::recorderSrv srvRequest;
    ...
    ROS_ERROR("FILENAMES SET, Waiting 2 s to start recording:");
    ros::Duration dur(10);
    clientObj.call(srvRequest); //set filename/path node4
